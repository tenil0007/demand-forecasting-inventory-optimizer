...
from backend.models.forecast_model import ForecastModel, forecast_model

def predict_sku_demand(store_id: str = "S001", product_id: str = "P001", days_ahead: int = 14):
...
if __name__ == "__main__":
    ...
    product = sys.argv[2] if len(sys.argv) > 2 else "P001"
